                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      Auth().signUpWithEmailAndPassword(emailController.text, passwordController.text, context)
                          .then((value) {
                        if (value == 0) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Successfully signed up, please login'),
                              backgroundColor: Colors.green,
                            ),
                          );
                            Navigator.pushNamed(context, StocklyRoutes.loginRoute);
                        }
                        if (value == 1) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
